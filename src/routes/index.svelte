...
<div class="flex flex-col justify-center items-center h-[100vh] w-[100vw]">
  <div class="flex-grow flex flex-col justify-center items-center py-8">
    ...
    <p class="my-4 mx-2 italic dark:text-slate-100 text-center">{releaseDateAnnounced ? `${formatDistanceToNowStrict(ow2ReleaseDate)} until release on ${format(ow2ReleaseDate, "MMMM do, yyyy")}` : "...and no release date has been announced yet."}</p>
  </div>
